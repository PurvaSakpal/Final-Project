...
class ApiController extends Controller
{
    ...
    public function Login(Request $request){
        ...
        if($validator->fails()){
            ...
            if(!$token=auth()->guard('api')->attempt($validator->validated())){
                return response()->json(['err'=>1],401);
            }
            else{
    ...
    public function ApplyCoupon(Request $req){
        ...
        // return response()->json(['success'=>"Coupon applied sucessfully"]);
    ...
    public function PlaceOrder(Request $req){
        ...
        if($user->useraddress()->save($useradd))
        {
            ...
            if(!empty($coupon_id)){
                ...
                $coup=CouponsUsed::latest()->first();
                // $useraddress=UserAddress::latest()->first();
